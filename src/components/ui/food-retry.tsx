    ...
    <div className="relative w-full h-full">
      ...
      <div className="bg-card w-full h-24 flex rounded-xl overflow-hidden shadow-sm border border-border/50">
        <img
          src={food.image}
          alt={food.foodName}
          className="w-30 h-full object-cover rounded-[5px]"
        />
        <div className="flex flex-col gap-2.5 px-4 py-2.5 flex-1">
          <div className="flex justify-between w-full">
            <div className="w-24 h-4 bg-linear-to-r bg-red-900 rounded-[5px] overflow-hidden relative"></div>
          ...
          <div className="w-24 h-5 bg-linear-to-r bg-red-900 rounded-[5px] overflow-hidden relative"></div>
          <div className="grid grid-cols-3 gap-3">
            {[0, 1, 2].map((i) => (
              <div
                key={i}
                className="w-full h-4 bg-linear-to-r bg-red-900 rounded-[5px] overflow-hidden relative"
              ></div>
            ))}
          </div>
        </div>
